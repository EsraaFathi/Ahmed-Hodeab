            ...
            <>
              ...
              <li className="p-4">
                <Link to="/register" onClick={handleNav}>
                  <button className="bg-primaryBG text-white px-4 py-2 rounded-md hover:bg-primaryBG transition duration-300 animate-pulse hover:animate-none hover:shadow-lg hover:shadow-gray-300">
                    إنشاء حساب
                  </button>
                </Link>
              </li>
