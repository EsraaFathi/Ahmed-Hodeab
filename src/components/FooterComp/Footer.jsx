      ...
      >
        <div className="flex justify-center w-full items-center text-gray-400">
          {/* <a
            ...
            className=" text-gray-400 mx-2 hover:underline "
          >
            Promisify
          </a> */}
          {/* و */}
          <a
            href="https://www.facebook.com/Mahdi.Agency"
            className=" text-gray-400 hover:underline mx-2"
          >
            Mahdi Agency
          </a>
          | جميع الحقوق محفوظة © {new Date().getFullYear()} بدعم من
        </div>
      </div>
    </footer>
  );
